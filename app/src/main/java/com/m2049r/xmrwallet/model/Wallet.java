...
public class Wallet {
    ...
    /* ---------------------------------------------------------------------
     * Multisig Convenience Wrappers (FIXED - all Arrays.asList converted to ArrayList)
     * ------------------------------------------------------------------ */
     ...
     * FIXED: Converts Arrays.asList to proper ArrayList to avoid JNI type mismatch.
     * 
     ...
     * @return Result string with extra multisig info if more rounds needed
     */
    public String exchangeMultisigKeys(String[] multisigInfoArray, boolean forceUpdateUseWithCaution) {
        java.util.ArrayList<String> list = new java.util.ArrayList<>(java.util.Arrays.asList(multisigInfoArray));
        return exchangeMultisigKeys((Object) list, forceUpdateUseWithCaution);
    }
