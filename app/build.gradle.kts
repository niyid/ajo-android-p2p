...
android {
    namespace = "com.techducat.ajo"
    compileSdk = 35
    
    defaultConfig {
        applicationId = "com.techducat.ajo"
        minSdk = 24
        targetSdk = 35
        versionCode = 1
        versionName = "0.0.1"
    ...
    buildTypes {
        release {
            // Service Wallet Backend Configuration
            buildConfigField("String", "SERVICE_BACKEND_URL", "\"https://ajo-backend.fly.dev\"")
            buildConfigField("String", "SERVICE_API_KEY", "\"DLi-ozM9vHJRutVqtBGIq0Tlcq6gd2J60HTXsmFP0xU\"")
            
            // Other API keys
            buildConfigField("String", "CHANGENOW_API_KEY", "\"prod-api-key\"")
            buildConfigField("String", "BACKEND_URL", "\"https://api.yourapp.com\"")
        ...
        debug {
            // Service Wallet Backend Configuration (same for both debug and release)
            buildConfigField("String", "SERVICE_BACKEND_URL", "\"https://ajo-backend.fly.dev\"")
            buildConfigField("String", "SERVICE_API_KEY", "\"DLi-ozM9vHJRutVqtBGIq0Tlcq6gd2J60HTXsmFP0xU\"")
            
            // Other API keys
            buildConfigField("String", "CHANGENOW_API_KEY", "\"dev-api-key\"")
            buildConfigField("String", "BACKEND_URL", "\"http://192.168.1.100:3000\"")
